...
public class GlobalExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        var (statusCode, response) = exception switch
        {
            ...
            FluentValidation.ValidationException fluentEx => HandleFluentValidationException(fluentEx),
    ...
    private (HttpStatusCode, ApiResponse) HandleFluentValidationException(FluentValidation.ValidationException ex)
    {
