...
public interface IBillService
{
    ...
    /// <param name="ct">取消令牌</param>
    Task<Result<SyncBillResponseDto>> SyncBillAsync(SyncBillRequestDto dto, Guid? ownerId,
    ...
    /// <param name="ct">取消令牌</param>
    Task<Result<DeltaSyncResponse>> DeltaSyncAsync(Guid billId, DeltaSyncRequest request, Guid? userId,
        CancellationToken ct = default);
}
