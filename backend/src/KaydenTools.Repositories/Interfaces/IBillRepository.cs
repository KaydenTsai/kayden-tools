...
public interface IBillRepository : IRepository<Bill>
{
    ...
    /// <summary>
    /// 根據前端本地 ID 和擁有者 ID 取得帳單（用於冪等性檢查）
    /// </summary>
    /// <param name="localClientId">前端本地 ID</param>
    /// <param name="ownerId">擁有者 ID</param>
    /// <param name="ct">取消令牌</param>
    Task<Bill?> GetByLocalClientIdAndOwnerAsync(string localClientId, Guid ownerId, CancellationToken ct = default);
}
