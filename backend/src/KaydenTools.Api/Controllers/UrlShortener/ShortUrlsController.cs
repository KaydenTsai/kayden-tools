...
namespace KaydenTools.Api.Controllers.UrlShortener;
...
[ApiController]
[Route("api/urls")]
[ApiExplorerSettings(GroupName = "urlshortener")]
[Tags("ShortUrls")]
...
public class ShortUrlsController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] CreateShortUrlDto dto, CancellationToken ct)
    {
        ...
        if (result.IsFailure) return BadRequest(ApiResponse.Fail(result.Error.Code, result.Error.Message));
