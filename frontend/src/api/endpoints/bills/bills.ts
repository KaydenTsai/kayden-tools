...
export const getBillById = (id: string, signal?: AbortSignal) => {
  return customInstance<BillDtoApiResponse>({
    url: `/api/snap-split/Bills/${id}`,
    method: "GET",
    signal,
  });
};
...
export const getGetBillByIdQueryKey = (id?: string) => {
  return [`/api/snap-split/Bills/${id}`] as const;
};
...
export const getBillByShareCode = (shareCode: string, signal?: AbortSignal) => {
  return customInstance<BillDtoApiResponse>({
    url: `/api/snap-split/Bills/share/${shareCode}`,
    method: "GET",
    signal,
  });
};
...
export const getGetBillByShareCodeQueryKey = (shareCode?: string) => {
  return [`/api/snap-split/Bills/share/${shareCode}`] as const;
};
...
export const getMyBills = (signal?: AbortSignal) => {
  return customInstance<BillDtoIReadOnlyListApiResponse>({
    url: `/api/snap-split/Bills/mine`,
    method: "GET",
    signal,
  });
};
...
export const getGetMyBillsQueryKey = () => {
  return [`/api/snap-split/Bills/mine`] as const;
};
...
export const generateShareCode = (id: string, signal?: AbortSignal) => {
  return customInstance<ObjectApiResponse>({
    url: `/api/snap-split/Bills/${id}/share-code`,
    method: "POST",
    signal,
  });
};
...
export const syncBill = (
  ...
  return customInstance<SyncBillResponseDtoApiResponse>({
    url: `/api/snap-split/Bills/sync`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export const deltaSyncBill = (
  ...
  return customInstance<DeltaSyncResponseApiResponse>({
    url: `/api/snap-split/Bills/${id}/delta-sync`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
